...
function ItemsWithPointsPage({ onSelectedChange }) {
  ...
  const { medicines, count, status, pageState } = useSelector(
    selectItemsWithPointsMedicines
  );
...
export default ItemsWithPointsPage;

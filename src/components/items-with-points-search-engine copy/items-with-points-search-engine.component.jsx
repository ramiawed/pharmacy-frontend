...
const ItemsWithPointsSearchEngine = ({ handleEnterPress, keyUpHandler }) => {
  const { t } = useTranslation();
  const dispatch = useDispatch();
  const { pageState } = useSelector(selectItemsWithPointsMedicines);
...
export default ItemsWithPointsSearchEngine;
